            ...
            <nav class="border-b border-gray-100 bg-white">
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-between">
                        ...
                        <!-- Right Side Menu -->
                        <div
                            class="hidden space-x-6 sm:ms-6 sm:flex sm:items-center"
                        >
                            <!-- 🛒 Cart Link -->
                            <Link
                                href="/cart"
                                class="relative inline-flex items-center text-gray-700 hover:text-blue-600"
                            >
                                🛒
                                <span
                                    v-if="cartCount > 0"
                                    class="absolute -right-2 -top-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-red-600 text-xs text-white"
                                >
                                    {{ cartCount }}
                                </span>
                            </Link>
